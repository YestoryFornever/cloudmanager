...
export class InvoiceManagementComponent implements OnInit{
	...
	getInvoiceList(){
		...
		if(this.myEndTime){
			this.default.requestTimeEnd = this.makeTemp( this.myEndTime) +57599000 ;
		}
		if(this.myStartTime){
			this.default.requestTimeStart = this.makeTemp( this.myStartTime) -28800000 ;
		}
	...
	getInvoiceDetail(invoiceId:any){
		...
		this.router.navigate(['../invoice-details',{invoiceId:invoiceId}],{relativeTo:this.activatedRoute});
	}
