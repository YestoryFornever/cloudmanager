...
@Component({
	selector: 'bad-list-management',
	templateUrl: './bad-list-management.component.html',
	styleUrls: ['./bad-list-management.component.css']
})

export class BadListManagementComponent implements OnInit{ 
	ngOnInit(){
	};
