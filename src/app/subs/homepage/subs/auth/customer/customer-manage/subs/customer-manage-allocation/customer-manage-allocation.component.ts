...
@Component({
	...
	styleUrls: ['./customer-manage-allocation.component.css'],
...
// 类管理
	...
	// 跳转
	toChange(){
	   this.router.navigate(['../../../../customer-manage-serch',this.id,this.uName,this.lName],{relativeTo:this.activatedRoute}); 
	}
	//省市联动
