...
@Component({
	...
	styleUrls: [
        './organization-statistics.component.css',
        '../../../../css/header.css',
        '../../../../css/table.css',
        '../../../../css/condition.css',
        '../../../../css/pagination.css'
...
export class OrganizationStatisticsComponent implements OnInit{ 
    ...
    postListMsges(){
//获取机构全称服务
    this.organizationStatisticsService.OrganizationList(null) 
        .subscribe(
            companylist => {
 ...
 //获取机构统计列表
    statisticList(){
       ...
       this.organizationStatisticsService.StatisticsList(this.default1)
            .subscribe(
