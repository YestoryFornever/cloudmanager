...
export class OrganizationListComponent implements OnInit {
	...
	changeIssuerId(e:TypeaheadMatch){
	...
	viewOrgUserList(org:Organization){
		//console.log(org.id);
		//debugger;
		this.router.navigate(['../user-list',org.id],{relativeTo:this.activatedRoute}); 
	}
	viewDepUserList(dep:any){
		this.router.navigate(['../user-list',{orgid:dep.organizationId,depid:dep.departmentId}],{relativeTo:this.activatedRoute}); 
	}
	// 分页
